VERSION 5.00
Begin VB.UserControl AOLCmd 
   ClientHeight    =   1320
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2370
   MouseIcon       =   "AOLCmd.ctx":0000
   ScaleHeight     =   1320
   ScaleWidth      =   2370
   ToolboxBitmap   =   "AOLCmd.ctx":0152
...
'# Description                             #
'#                                         #
'# This is a very customizable AOL button  #
'# replication.  If you leave it to        #
'# StandardColors it looks EXACTLY and I   #
'# mean exactly like real AOL buttons.     #
'# But, if you would like ot play around   #
'# you can do so.  It also supports images #
'# on the buttons.                         #
'###########################################
'# How To Use                              #
'#                                         #
'# It's like a regular command button,     #
'# just looks like AOL buttons.  If you    #
'# want to compile this into a program you #
'# must set the Public property to false   #
'# of else you will get an error.  If you  #
'# would like to change the color, you     #
'# must set 'StandardColors' to false or   #
'# it will not let you change them.        #
'###########################################
'# More Info                               #
'# http://paa.11net.com                    #
'###########################################
